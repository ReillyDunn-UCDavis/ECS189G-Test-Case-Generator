...
def main():
    ...
    model_a_tests = [
        ...
        {"input": {"nums": [1, 2, 3],        "target": 5},   "expected_output": [0, 2]}, # wrong: should be [1,2]
    ]

    model_b_tests = [
        {"input": {"nums": [2, 7, 11, 15], "target": 9},  "expected_output": [0, 1]},
        {"input": {"nums": [],              "target": 5},   "expected_output": []}, # empty_input
        {"input": {"nums": [5],             "target": 5},   "expected_output": []}, # single_element + no_solution
        {"input": {"nums": [1, 3, 2, 6],   "target": 9},   "expected_output": [2, 3]},
        # max_constraints: large list
        {
            "input": {
                "nums": list(range(10_001)) + [9999],
                "target": 10_000 + 9999,
            },
            "expected_output": [10_000, 10_001],
        },
    ]
    ...
    results = [
        evaluate_model(
            model_name="Model A (fine-tuned T5)",
        ...
        evaluate_model(
            model_name="Model B (GPT-4 baseline)",
